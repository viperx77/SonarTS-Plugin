...
/**
 * This logic is required to be compatible with SQ<6.2 (method InputFile#contents() was introduced in SQ 6.2).
 * It can be removed as soon as plugin migrated to 6.x LTS.
 */
